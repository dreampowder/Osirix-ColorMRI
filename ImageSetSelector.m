...
@interface ImageSetSelector ()<PXSourceListDelegate,PXSourceListDataSource,NSCollectionViewDelegate,NSCollectionViewDataSource>
    ...
    @property (strong) IBOutlet NSButton* btnReverseOrder;
...
- (void)populateRGBButtons{
    ...
    [self.btnRed.menu setTitle:@"Red Series"];
    [self.btnGreen.menu setTitle:@"Green Series"];
    [self.btnBlue.menu setTitle:@"Blue Series"];
...
- (IBAction)didClickDoneButton:(id)sender{
    ...
    [self.delegate didSelectRedChannel:self.redSeries greenChannel:self.greenSeries blueChannel:self.blueSeries isReverseOrder:(_btnReverseOrder.state==NSControlStateValueOn)];
    [self.window.sheetParent endSheet:self.window returnCode:NSModalResponseOK];
