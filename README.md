...
<p>An RGB Image Composer Plugin developed for Osirix  image processing application. The plugin lets users to choose 2 or 3 image sets from the same locations of a patient, and composes them into a single RGB Image Set</p>
